...
class TaskRepositoryCreateIT extends H2BaseTest {
    ...
    void createParam() {
        ...
        Assertions.assertEquals(params, receivedTasks.get(0).getTaskParameters());
        Assertions.assertEquals(newTask, receivedTasks.get(0));
    }
    ...
    void createSubtaskParam() {
        ...
        Assertions.assertEquals(subparams, receivedTasks.get(0).getSubTasks().get(0).getTaskParameters());
        Assertions.assertEquals(params, receivedTasks.get(0).getTaskParameters());
        Assertions.assertEquals(newTask, receivedTasks.get(0));
    }
}
